...
directorys=['FC_temp_models','Mask_temp_models','Fixup_temp_models','Selected_models','interactions','UCB','log']  # temp models
...
ctx = mx.gpu(4) if mx.context.num_gpus() > 0 else mx.cpu(0)
